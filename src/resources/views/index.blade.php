        ...
        <table class="contact__form-table">
            ...
            <tr>
                ...
                <td class="name-wrapper">
                    <div class="contact__form-item-wrapper">
                        <input type="text" name="last_name" class="contact__form-item name" placeholder="例: 山田" value="{{ old('last_name') }}">
                    ...
                    <div class="contact__form-item-wrapper">
                        <input type="text" name="first_name" class="contact__form-item name" placeholder="例: 太郎" value="{{ old('first_name') }}">
            ...
            <tr>
                ...
                <td class="phone-wrapper">
                    <div class="contact__form-item-wrapper">
                        <input type="text" name="phone1" class="contact__form-item phone" maxlength="5" pattern="\d{1,5}" placeholder="例: 080" value="{{ old('phone1') }}">
                    ...
                    <div class="contact__form-item-wrapper">
                        <input type="text" name="phone2" class="contact__form-item phone" maxlength="5" pattern="\d{1,5}" placeholder="例: 1234" value="{{ old('phone2') }}">
                    ...
                    <div class="contact__form-item-wrapper">
                        <input type="text" name="phone3" class="contact__form-item phone" maxlength="5" pattern="\d{1,5}" placeholder="例: 5678" value="{{ old('phone3') }}">
